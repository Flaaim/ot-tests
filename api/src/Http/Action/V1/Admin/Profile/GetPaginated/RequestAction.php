...
namespace App\Http\Action\V1\Admin\Profile\GetPaginated;

use App\Infrastructure\Http\Validator\Validator;
use App\Profile\Query\GetUsersPaginated\Query;
use App\Profile\Query\GetUsersPaginated\QueryHandler;
...
final class RequestAction
{
    ...
    #[Route('/v1/admin/profiles', name: 'admin.profiles.get', methods: ['GET'])]
